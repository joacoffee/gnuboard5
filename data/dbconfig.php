...
define('G5_MYSQL_HOST', 'mariadb');
define('G5_MYSQL_USER', 'pajutop');
define('G5_MYSQL_PASSWORD', '123!');
define('G5_MYSQL_DB', 'pajutop');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '948b0876be5bfb37a656b285a129ded1'); // 토큰 암호화에 사용할 키
